...
$string['schoolkey_desc'] = 'The school_key used to link this Moodle instance to a school in Pikapon.';
$string['plagiarismsettings'] = 'Plagiarism settings';
$string['checkplagiarism'] = 'Check plagiarism';
$string['checkplagiarism_help'] = 'Enable this to automatically check submissions for plagiarism.';
$string['viewstudent'] = 'Allow student view';
$string['viewstudent_help'] = 'Enable this to student view check submissions for plagiarism.';
